...
function App() {
  return (
    <div className="container mt-4">
      ...
      <div className="mb-4">
        <h1 className="display-4 text-center fw-bold text-primary">Octofit Tracker Fitness App</h1>
      </div>
      <Routes>
        ...
        <Route path="/" element={<div className="card p-4 shadow-sm"><h2 className="card-title text-center">Welcome to Octofit Tracker!</h2><p className="card-text text-center">Track your fitness, join teams, and compete on the leaderboard.</p></div>} />
      </Routes>
    </div>
  );
}
